        ...
        >
            <div class="w-full lg:w-6/12 py-6 relative written-text">
                <div class="flex w-64 md:w-96 m-auto flex-col justify-center">
                    ...
                    <p  ref="text" class="texts pb-4 text-white text-base" v-html="formattedText" >
...
export default {
  data() {
    return {
      originalText: "I, as a full stack developer, can provide the technical expertise and creative solutions necessary to build a website that stands out by reflecting how you want the world to see you...", // Replace with your text
      letters: [],
    };
  },
  computed: {
